...
export function WorkGrid() {
  ...
  if (!publicCaseStudies.length) return <section className="empty-state" aria-labelledby="no-work-title"><p className="eyebrow">Work</p><h2 id="no-work-title">Proof is published with its context intact.</h2><p>Detailed project studies are being prepared with the required context and permissions. In the meantime, request a private capabilities review for a relevant example.</p><Link className="button" href="/contact">Request a project review</Link></section>;
